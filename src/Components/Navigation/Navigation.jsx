...
function ResponsiveDrawer(props) {
  ...
  const [alumnoSeleccionado, cambiarAlumnoSeleccionado] = useState(ArchivosDeAlumnos[0])
  ...
  return (
    <div className={classes.root}>
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>
            Equipo Azul / {alumnoSeleccionado.nombreAlumno}
          </Typography>
        </Toolbar>
      </AppBar>
      ...
      <main className={classes.content}>
        <div className={classes.toolbar} />
        <Table alumnoSeleccionado={alumnoSeleccionado} />
      </main>
    </div>
  );
}
